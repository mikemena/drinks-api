...
class PrivateIngredientsApiTest(TestCase):
    ...
    def test_filter_ingredients_assigned_to_recipes(self):
        ...
        in1 = Ingredient.objects.create(user=self.user, name="Coke")
    ...
    def test_filtered_ingredients_unique(self):
        ...
        ing = Ingredient.objects.create(user=self.user, name="Rum")
        Ingredient.objects.create(user=self.user, name="Orang Juice")
